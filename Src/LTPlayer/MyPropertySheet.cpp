...
BOOL CMyPropertySheet::OnInitDialog()
{
	...
	//CWnd* _b1 = GetDlgItem(IDOK);
	//_b1->ShowWindow(SW_HIDE);
	//CWnd* _b2=GetDlgItem(IDCANCEL);
	//_b2->ShowWindow(SW_HIDE);
	CWnd* _b3=GetDlgItem(IDHELP);
	_b3->ShowWindow(SW_HIDE);
